...
from app.api.v1 import auth, users, forms, nominations, awards, cycles, panels, panel_assignments, bulk_jobs, system
...
api_router.include_router(bulk_jobs.router, prefix="/bulk-jobs", tags=["Bulk Jobs"])
